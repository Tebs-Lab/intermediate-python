...
# One last helpful trick. If an error occurs during the request, the
# default behavior of requests is to give you the error code. But 
# often, if the response failed, you just want to raise an error 
# yourself, especially during the debugging phase. You can do this
# with the raise_for_status method:
r = requests.get('https://www.google.com/this-will-cause-a-404')
r.raise_for_status()
