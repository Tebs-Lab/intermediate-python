...
# Note that: there are a LOT of other built in tools for 
# iteration in Python. Before you reinvent the wheel, check
# out the itertools documentation: https://docs.python.org/3.11/library/itertools.html

# Micro-exercise: Find the "product" function in the above documentation
# and use it to compute every possible permutation of three items chosen
# from the following list, then print the permutations:
