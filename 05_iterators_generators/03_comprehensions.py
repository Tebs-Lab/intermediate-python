...
# If you use parenthesis instead of square braces, the result is a generator
# instead of a list. This is useful when you don't need to store the sequence.
currency_gen = (f'${num}.00' for num in evens)
print(currency_gen)
for c in currency_gen:
    print(c)
